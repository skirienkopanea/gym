package myApp.eventlisteners;

import javafx.fxml.FXML;
import javafx.scene.control.Button;
import javafx.scene.control.ListView;
import javafx.scene.control.TextField;
import myApp.clientrequests.SongRequest;
...
public class HomePage {
    ...
    public void searchSongs() {
        ...
        //This calls for a method that makes a query and returns a list of songs (and assigns it to return)
        List<Song> songs = SongRequest.getSongs(input.getText()); //getText() is a default javafx method
    ...
    public void testButton() {
        ...
        //This calls for a method that makes a query and returns a list of songs (and assigns it to return)
        List<Song> songs = SongRequest.mockSong(); //getText() is a default javafx method
